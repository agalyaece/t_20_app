...
export default function UpdatePlayerDetails() {
  ...
  function handleUpdatePlayer(event) {
    ...
    axios.put(`/cricket/icc_world_cup/:country_1/vs/:country_2/updateplayer/${id}`, player)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`/cricket/icc_world_cup/${country_1}/vs/${country_2}/addPlayerDetails/getOneplayer/${id}`)
      .then((response) => {
